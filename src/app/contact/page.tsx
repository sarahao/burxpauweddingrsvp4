...
<br className="mb-[4px]" />
              ...
              {showButton && (
        <div className="fixed bottom-8 right-8 z-[1000] md:bottom-10 md:right-10">
          <button 
            onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} 
            className="bg-gray-900 hover:bg-gray-700 text-white w-10 h-10 md:w-12 md:h-12 rounded-full shadow-lg flex items-center justify-center text-lg md:text-xl transition-all duration-300"
          >
            ↑
          </button>
        </div>
