...
export default function Home() {
  ...
  return (
    <>
      ...
      {showButton && (
        <div className="fixed bottom-4 right-4 md:bottom-5 md:right-5 z-[1000]">
          <button 
            onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} 
            className="bg-gray-900 text-white w-8 h-8 md:w-10 md:h-10 rounded-full shadow-lg 
              hover:bg-gray-700 transition-all flex items-center justify-center text-sm md:text-base"
          >
            ↑
          </button>
        </div>
